...
[https://nornickel-ai-hackathon.ru/task-2](https://nornickel-ai-hackathon.ru/task-2)
...
3. Архив с исходным кодом проекта
4. Видео-демо работы проекта (видео, показывающее процесс работы вашего решения, с комментариями или без них, не длиннее __ минут)
5. Ссылка на презентацию вашего проекта (облачный диск с файлом .pptx/.pdf или развернутая презентация на YouNote, Figma или иных сервисах)
6. Ссылка на ваше развернутое решение (при наличии) для его тестирования членами жюри.

Данные для кейса
[https://disk.yandex.ru/d/npigiuw4Rbe9Pg](https://disk.yandex.ru/d/npigiuw4Rbe9Pg)